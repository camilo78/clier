...
<head>
    <meta charset="utf-8">
    <title>{{ $companyInfo->name ?? 'Nombre Empresa' }} -
        {{ $companyInfo->description ?? 'Plantilla Web de Reparación de Aire Acondicionado' }}</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name={{ $companyInfo->description ?? 'Plantilla Web de Reparación de Aire Acondicionado' }}>
