{{-- Crear servicio: formulario con subida de imagen e icono --}}
<section class="w-full">
    {{-- Encabezado --}}
    <x-page-heading>
        <x-slot:title>Crear Servicio</x-slot:title>
        <x-slot:subtitle>Crea un nuevo servicio para tu empresa</x-slot:subtitle>
        <x-slot:buttons>
    ...
    <form wire:submit="save" class="space-y-6">
                    ...
                    <div class="mt-3">
                        <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center cursor-pointer hover:border-gray-400 dark:hover:border-gray-500 transition-colors"
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                <span class="font-medium text-blue-600">Subir imagen</span> o arrastra aquí
                            </p>
                ...
                <div class="relative">
                    ...
                    <div class="mt-3">
                        <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center cursor-pointer hover:border-gray-400 dark:hover:border-gray-500 transition-colors"
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                <span class="font-medium text-blue-600">Subir icono</span> o arrastra aquí
                            </p>
                            <p class="text-xs text-gray-500 mt-1">PNG, JPG hasta 2MB</p>
        ...
        <div class="flex justify-end">
            ...
            <flux:button 
                type="submit" 
                variant="primary" 
                class="ml-3 min-w-[130px]"
            >
                <span wire:loading.remove wire:target="save">Crear Servicio</span>
