<section class="w-full">
    <x-page-heading>
        <x-slot:title>Crear Testimonio</x-slot:title>
        <x-slot:subtitle>Crea un nuevo testimonio de cliente</x-slot:subtitle>
        <x-slot:buttons>
    ...
    <form wire:submit="save" class="space-y-6 col-span-full">
                        ...
                        @if ($newImage)
                            <div class="text-center">
                                <img src="{{ $newImage->temporaryUrl() }}" alt="Nueva imagen"
                                    class="h-20 w-20 object-cover rounded-full mx-auto mb-1">
                                <span class="text-xs text-green-600 dark:text-green-400 font-medium">✓ Nueva imagen</span>
                            </div>
                        @else
        ...
        <div class="flex justify-end">
            ...
            >
                <span wire:loading.remove wire:target="save">Crear Testimonio</span>
