{{-- Crear slide: formulario con subida de imagen y validación 16:9 --}}
<section class="w-full">
    <x-page-heading>
        <x-slot:title>Crear Slide</x-slot:title>
        <x-slot:subtitle>Crea un nuevo slide para el carousel</x-slot:subtitle>
        <x-slot:buttons>
    ...
    <form wire:submit="save" class="space-y-6 col-span-full">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-80 flex-shrink-0">
                ...
                <div class="relative">
                    <div wire:key="image-preview-{{ $newImage ?? 'empty' }}" style="height: 146px;"
                        ...
                        @if ($newImage)
                            <div class="text-center">
                                ...
                                <span class="text-xs text-green-600 dark:text-green-400 font-medium">✓ Nueva
                                    imagen</span>
                            </div>
                        @else
        ...
        <div class="flex justify-end">
            ...
            <flux:button 
                type="submit" 
                variant="primary" 
                class="ml-3 min-w-[120px]"
            >
                <span wire:loading.remove wire:target="save">Crear Slide</span>
